...
<div class="card">
  <div class="card-header">
    {{ trans('global.create') }} {{ trans('cruds.myProduct.title_singular') }}
  </div>
      ...
      <div class="col-md-6">
        <form method="POST" action="{{ route("admin.shop-products.store") }}" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock') ? 'is-invalid' : '' }}" type="text" name="stock"
          ...
          <div class="form-group">
            ...
            <select class="form-control select2 {{ $errors->has('shop_product_categories') ? 'is-invalid' : '' }}"
              ...
              <option value="{{ $id }}" {{ in_array($id, old('shop_product_categories', [])) ? 'selected' : '' }}>{{
          ...
          <div class="form-group">
            <label for="shop_product_sub_categories">{{ trans('cruds.shopProduct.fields.shop_product_sub_categories')
              }}</label>
            <div style="padding-bottom: 4px">
              <span class="btn btn-info btn-xs select-all" style="border-radius: 0">{{ trans('global.select_all') }}</span>
              <span class="btn btn-info btn-xs deselect-all" style="border-radius: 0">{{ trans('global.deselect_all')
            ...
            <select class="form-control select2 {{ $errors->has('shop_product_sub_categories') ? 'is-invalid' : '' }}"
              ...
              <option value="{{ $id }}" {{ in_array($id, old('shop_product_sub_categories', [])) ? 'selected' : '' }}>{{
          ...
          <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('attachment_name') ? 'is-invalid' : '' }}" type="text"
              name="attachment_name" id="attachment_name" value="{{ old('attachment_name', '') }}">
          ...
          <div class="form-group">
            <div class="form-check {{ $errors->has('state') ? 'is-invalid' : '' }}">
              ...
              <input class="form-check-input" type="checkbox" name="state" id="state" value="1" {{ old('state', 0)==1 ||
                old('state')===null ? 'checked' : '' }}>
